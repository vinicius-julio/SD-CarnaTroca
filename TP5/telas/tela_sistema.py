...
def switch_tela_sistema(entrada, nome):
    if entrada == '1':
        ...
        fantasia = cliente.Cliente.criaNovoAnuncio(nomeFantasia, descricao, tamanho, nome)
        ...
        if (fantasia == 'aprovado'):        
            ...
            switch_tela_sistema(entrada, nome)
        else:
            os.system('clear')
        ...
        lista = cliente.Cliente.listaFantasia(nome)
        ...
        if (lista == None):        
            ...
            entrada = input('Escolha uma das opcoes acima para continuar:')
            tela_troca.switch_tela_troca(entrada, nome)


    elif entrada == '3':
        print('\033[1;36mVer todos meus anuncios\033[m')
        
        lista = cliente.Cliente.listaMeusAnuncios(nome)
