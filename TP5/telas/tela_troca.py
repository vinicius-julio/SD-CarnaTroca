...
def switch_tela_troca(entrada , nome):
    if(entrada == '1'):
        ...
        troca = cliente.Cliente.proporTroca(ID_item_anunciante, ID_item_proponente, nome)
        ...
        if (troca == 'erro'):      
            ...
            switch_tela_troca(entrada , nome)
        else:
            os.system('clear')
        ...
        troca = cliente.Cliente.listaTroca(nome)
        ...
        entrada = input('Escolha uma das opcoes acima para continuar:')
        tela_sistema.switch_tela_sistema(entrada, nome)
...
def switch_tela_troca2(troca ,nome):
    if(troca == '1'):

        ID_troca =  input('\nInforme o ID da troca que deseja aceitar:')
        
        finaliza_troca = cliente.Cliente.aceitaTroca(ID_troca, nome)
        ...
        finaliza_troca = cliente.Cliente.recusaTroca(ID_troca, nome)
